...
0415   01 max-value pic 9.
0416   01 array-size pic 99 value 5.
0417   01 input-array pic x(20).  *> Максимальная длина ввода - 20 символов
0916
0500   procedure division.
0510
0511   program-begin.
0512       perform display-array.
0513       perform find-max-value-in-array.
0514       perform display-max-value.
0515
0800   program-done.
0900       stop run.
1000
...
1015
1016   find-max-value-in-array.
1017       move array(1) to max-value.
1018       perform varying index-array from 2 by 1
1019               until index-array > array-size
1020           if array(index-array) > max-value
1021               move array(index-array) to max-value
1022           end-if
1023       end-perform.
2000
2001   display-max-value.
2002       display "Max value = " max-value.
2003
